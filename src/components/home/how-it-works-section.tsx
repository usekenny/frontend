...
const steps = [
    {
        ...
        videoUrl: "https://cdn.prod.website-files.com/61b3737273405dd7b65eec4c%2F68ed3ab6e8162e7baa0b868a_video-1-transcode.mp4"
    },
    {
        number: "02",
        icon: Brain,
        ...
        videoUrl: "https://cdn.prod.website-files.com/61b3737273405dd7b65eec4c%2F68ed4058959760426e5e4779_video-2-transcode.mp4"
    },
    {
        number: "03",
        icon: Store,
        ...
        videoUrl: "https://cdn.prod.website-files.com/61b3737273405dd7b65eec4c%2F68ed4189738859bdebb81ecc_video-3-transcode.mp4"
    },
    {
        number: "04",
        icon: Zap,
        ...
        videoUrl: "https://cdn.prod.website-files.com/61b3737273405dd7b65eec4c%2F68ed45899473c4a9b86649e7_video-4-transcode.mp4"
    },
    {
        number: "05",
        icon: Sparkles,
        ...
        videoUrl: "https://cdn.prod.website-files.com/61b3737273405dd7b65eec4c%2F68ed461fd7af48aaabf760b9_video-5-transcode.mp4"
    }
];
            ...
            <div className="max-w-[1400px] mx-auto w-full px-4 sm:px-6">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="order-2 md:order-1">
                                    <div className="relative bg-foreground/5 border border-foreground/10 p-8 lg:p-10 hover:bg-foreground/10 hover:border-[#FF6B00]/50 transition-all group" style={{ borderRadius: 0 }}>
                                        {/* Number Badge */}
                                        <div className="absolute -top-6 -left-6 w-20 h-20 bg-gradient-to-r from-[#FF6B00] to-[#FF223B] flex items-center justify-center group-hover:scale-110 transition-transform"
                                        ...
                                        {/* Icon */}
                                        <div className="w-16 h-16 bg-black border border-[#FF6B00]/30 flex items-center justify-center mb-6 ml-10"
                                        ...
                                        {/* Highlight */}
                                        <div className="bg-gradient-to-r from-[#FF6B00]/10 to-transparent border-l-4 border-[#FF6B00] pl-4 py-3" style={{ borderRadius: 0 }}>
                                            <p className="text-base lg:text-lg text-foreground/90 font-semibold italic">
                                                {step.highlight}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="order-1 md:order-2">
                                    <div className="relative aspect-square bg-foreground/5 border border-foreground/10 flex items-center justify-center group hover:border-[#FF6B00]/50 transition-all overflow-hidden" style={{ borderRadius: 0 }}>
                                        <video
                                            src={step.videoUrl}
                                            autoPlay
                                            loop
                            ...
                            <div className="flex gap-2">
                                {steps.map((_, index) => (
                                    <button
                                        ...
                                        className={`h-2 transition-all ${index === currentStep
                ...
                <div className="md:hidden space-y-8">
                    {steps.map((mobileStep, index) => (
                        ...
                        >
                            {/* Media Vidéo */}
                            <div className="relative aspect-square bg-foreground/5 border border-foreground/10 flex items-center justify-center overflow-hidden" style={{ borderRadius: 0 }}>
                                <video
                            ...
                            <div className="relative bg-foreground/5 border border-foreground/10 p-6" style={{ borderRadius: 0 }}>
                                {/* Number Badge */}
                                <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-r from-[#FF6B00] to-[#FF223B] flex items-center justify-center"
                                    style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%)' }}>
                                    <span className="text-xl font-bold text-white" style={{ fontFamily: 'TECHNOS, sans-serif' }}>{mobileStep.number}</span>
                                </div>

                                {/* Icon */}
                                <div className="w-12 h-12 bg-black border border-[#FF6B00]/30 flex items-center justify-center mb-4 ml-8"
                                ...
                                {/* Highlight */}
                                <div className="bg-gradient-to-r from-[#FF6B00]/10 to-transparent border-l-2 border-[#FF6B00] pl-3 py-2" style={{ borderRadius: 0 }}>
                                    <p className="text-sm text-foreground/90 font-semibold italic">
                ...
                >
                    <p className="text-foreground/60 text-sm sm:text-base md:text-lg mb-4">
                        Ready to build your trading future?
                    </p>
                    {/* Changed div to a and added href for redirection */}
                    <a href="/connect-wallet" // Assuming '/connect-wallet' is the desired path for wallet connection
                        ...
                        style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%)' }}>
                        <div className="bg-background px-6 py-3 hover:bg-transparent transition-all flex items-center gap-2"
                            style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%)' }}>
