...
const team: TeamMember[] = [
  {
    name: "FLEO-TYPHON",
    role: "CEO",
    image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68de5637652a326681f5a5a3/039ae2e84_u9457137444_Cinematic_anime_concept_art_portrait_of_a_mysteri_f89ed810-e4e4-48cf-baec-15bff380b5f1_1.png",
  ...
  },
  {
    ...
    image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68de563762a326681f5a5a3/039ae2e84_u9457137444_Cinematic_anime_concept_art_portrait_of_a_mysteri_f89ed810-e4e4-48cf-baec-15bff380b5f1_1.png",
    socials: { twitter: "#", github: "#" }
  },
  {
    name: "0XCANET",
                ...
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2 sm:gap-3">
                    {member.socials.twitter && (
                      <a href={member.socials.twitter} className="w-8 h-8 sm:w-10 sm:h-10 bg-foreground/10 flex items-center justify-center hover:bg-[#FF6B00] transition-colors" style={{ borderRadius: 0 }}>
                        <Twitter className="w-4 h-4 sm:w-5 sm:h-5 text-foreground" />
                      </a>
                    )}
                    {member.socials.github && (
                      <a href={member.socials.github} className="w-8 h-8 sm:w-10 sm:h-10 bg-foreground/10 flex items-center justify-center hover:bg-[#FF6B00] transition-colors" style={{ borderRadius: 0 }}>
                        <Github className="w-4 h-4 sm:w-5 sm:h-5 text-foreground" />
                      </a>
                    )}
                    {member.socials.linkedin && (
                      <a href={member.socials.linkedin} className="w-8 h-8 sm:w-10 sm:h-10 bg-foreground/10 flex items-center justify-center hover:bg-[#FF6B00] transition-colors" style={{ borderRadius: 0 }}>
