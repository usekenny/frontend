            ...
            {result.tokens.slice(0, 3).map((token, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-gradient-to-r from-[#FF6B00] to-[#FF223B] flex items-center justify-center text-white font-bold title-font" style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%)' }}>
                    {index + 1}
                  </div>
                  <div>
                ...
                <div className="text-right">
                  <p className="text-[#FF223B] font-bold text-xl title-font">
