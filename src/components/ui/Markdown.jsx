      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ inline, className, children, ...props }) => {
            if (inline) {
              return (
                <code className="bg-white/10 px-1.5 py-0.5 rounded text-sm font-mono text-[#14F195]" {...props}>
                  {children}
                </code>
              );
            }
          ...
          h3: ({ children }) => (
            <h3 className="text-lg font-semibold mt-2 mb-1 text-white">{children}</h3>
          ),
          ...
          a: ({ href, children }) => (
            <a
              href={href}
              className="text-[#14F195] underline hover:text-[#FF5C1A] transition-colors"
              target="_blank"
          ...
          // Blockquotes
          blockquote: ({ children }) => (
            <blockquote className="border-l-2 border-[#FF5C1A] pl-4 my-2 italic text-white/80">
              {children}
            </blockquote>
          ),
