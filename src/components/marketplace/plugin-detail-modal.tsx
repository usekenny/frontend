          ...
          <div className="border-b border-foreground/10 p-6">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2 uppercase" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
                  {plugin.name}
                </h2>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <span className={`text-lg font-bold ${plugin.price === "FREE" ? 'text-[#14F195]' : 'text-[#FF6B00]'}`}>
                    {plugin.price}
                  </span>
                </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {activeTab === "overview" && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-bold text-foreground mb-4 uppercase" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
                    About This Plugin
                  </h3>
